...
\section*{Changes to \tcode{indirect} constructors}
...
\item
\textcolor{coered}{\tcode{is_constructible_v<T, U>} is \tcode{true}.}
\end{itemize}
...
\begin{itemize}
\item
\textcolor{coered}{\tcode{is_constructible_v<T, Us...>} is \tcode{true}, and}
\item
\tcode{is_default_constructible_v<Allocator>} is \tcode{true}.
\end{itemize}
...
\begin{itemize}
\item
\textcolor{coered}{\tcode{is_constructible_v<T, initializer_list<I>\&, Us...>} is \tcode{true}, and}
\item
\tcode{is_default_constructible_v<Allocator>} is \tcode{true}.
\end{itemize}
...
\section*{Changes to \tcode{polymorphic} constructors}
...
\item
\textcolor{coered}{\tcode{derived_from<UU, T>} is \tcode{true},}
\item
...
\item
\textcolor{coered}{\tcode{derived_from<U, T>} is \tcode{true},}
\item
