    ...
    if (NOT TARGET common_compiler_settings)
        ...
        target_compile_options(common_compiler_settings
            INTERFACE
                ...
                $<$<OR:$<CXX_COMPILER_ID:GNU>,$<CXX_COMPILER_ID:AppleClang>,$<CXX_COMPILER_ID:Clang>>:-ftemplate-backtrace-limit=0;-Werror;-Wall;-Wno-self-assign-overloaded;-Wno-delete-non-abstract-non-virtual-dtor;-Wno-unknown-warning-option;-Wno-self-move;-Wno-self-assign-overloaded>
        )
